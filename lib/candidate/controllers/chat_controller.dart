...
class ChatController extends GetxController {
  ...
  getChatList() async{
    try {
      QuerySnapshot querySnapshot = await _firestore.collection('messages').doc(_firebaseAuth.currentUser!.uid).collection(_firebaseAuth.currentUser!.uid).get();
      for (var item in querySnapshot.docs) {
        list.add(item.get('message'));
        debugPrint("heya>>>#${item}");
    ...
    // DocumentSnapshot ds = await _firestore.collection('messages').doc(_firebaseAuth.currentUser!.uid).get();
    // return ds.data();
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        return snapshot.data!.docs.isEmpty?const Center(child: Text("Hello, How may we help you?")):ListView(
